...
public class SmsLauncher {
	...
	public void sendTplSms(List<String> mobiles, String tplCode, List<String> contents) {
		String mobile = "";
	...
	public void sendTplSms(String[] mobiles, String tplCode, List<String> contents) {
		sendTplSms(Arrays.asList(mobiles), msTpls.get(tplCode), contents);
	}

	public void sendTplSms(String[] mobiles, String tplCode, String... contents) {
		sendTplSms(Arrays.asList(mobiles), msTpls.get(tplCode), Arrays.asList(contents));
	}
	...
	public void sendTplSms(String mobile, String tplCode, String... contents) {
		sendTplSms(mobile, msTpls.get(tplCode), Arrays.asList(contents));
	}
